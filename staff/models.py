...
class Doctor(Person):
    person = models.OneToOneField(User, related_name='doctors', on_delete=models.DO_NOTHING)
    avatar = models.ImageField(upload_to='avatars/doctors', null=True, blank=True)
    specialty = models.ManyToManyField(Speciality)
    user_type = models.ForeignKey(UserType, related_name='doctors', on_delete=models.DO_NOTHING)
...
class Nurse(Person):
    person = models.OneToOneField(User, related_name='nurses', on_delete=models.DO_NOTHING)
    avatar = models.ImageField(upload_to='avatars/nurses', null=True, blank=True)
    specialty = models.ManyToManyField(Speciality)
    user_type = models.ForeignKey(UserType, related_name='nurses', on_delete=models.DO_NOTHING)
...
class OtherStaff(Person):
    person = models.OneToOneField(User, on_delete=models.DO_NOTHING)
